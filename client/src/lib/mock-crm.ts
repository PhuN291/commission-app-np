...
export const PIPELINE_COLUMNS: { title: string; color: string; cards: PipelineCard[] }[] = [
  {
    title: "Moi lien he",
    color: "#b4e1fa",
    cards: [
      { customerId: 8, name: "Bui Quang Hai", phone: "0978901234", serviceInterest: "Kiem tra chuc nang Gan" },
      { customerId: 5, name: "Hoang Van Em", phone: "0945678901", serviceInterest: "Kham Tien hon nhan" },
    ],
  },
  {
    title: "Dang tu van",
    color: "#ffd6a4",
    cards: [
      { customerId: 2, name: "Le Thi Binh", phone: "0912345678", serviceInterest: "Kham suc khoe Nu gioi" },
      { customerId: 3, name: "Pham Hong Chuong", phone: "0923456789", serviceInterest: "Xet nghiem chat gay nghien" },
    ],
  },
  {
    title: "Da dat lich",
    color: "#e3d0ff",
    cards: [
      { customerId: 1, name: "Tran Van An", phone: "0901234567", serviceInterest: "Noi soi tieu hoa" },
      { customerId: 7, name: "Dang Thu Huong", phone: "0967890123", serviceInterest: "Kham Tien hon nhan" },
    ],
  },
  {
    title: "Hoan tat",
    color: "#bbe5b3",
    cards: [
      { customerId: 4, name: "Nguyen Thi Dieu", phone: "0934567890", serviceInterest: "Kham suc khoe Nu gioi" },
      { customerId: 6, name: "Vu Minh Phuc", phone: "0956789012", serviceInterest: "Tam soat Tim mach" },
    ],
  },
];
