...
| Tái khám | Worklist theo lượt, nhật ký từng cuộc gọi | VỪA | Nối số thật chờ iHOS |
...
| Luồng | App đang có | Độ chắc | Ghi chú |
|---|---|---|---|
| Tích hợp iHOS và website | Cột nguồn đơn, mã định danh, chống nhận trùng đã để sẵn | THẤP | Chưa nối thật |
| Sẵn sàng vận hành | Chưa go-live | THẤP | Giá vốn, Zalo OA, iHOS chờ ngoài |
...
- Số tiền bảo hiểm trên đơn hiện luôn bằng 0. Không màn nào cho nhập, cổng tạo đơn không gán, dữ
  liệu mẫu để trống. Đây là ô cắm sẵn chờ iHOS. Nhãn Có hỗ trợ hay Không hỗ trợ trên dịch vụ chỉ
...
2. Ngày nối iHOS, số bảo hiểm từng đơn sẽ về và app sẽ tự trừ khỏi cơ sở tính hoa hồng. Khi đó
